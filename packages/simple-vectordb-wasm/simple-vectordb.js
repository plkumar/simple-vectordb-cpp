...
var createSimpleVectorDB = (() => {
  var _scriptDir = import.meta.url;
  
  return (
async function(createSimpleVectorDB = {})  {

var Module = typeof createSimpleVectorDB != "undefined" ? createSimpleVectorDB : {};
...
if (Module["locateFile"]) {
 wasmBinaryFile = "simple-vectordb.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("simple-vectordb.wasm", import.meta.url).href;
}
...
run();
  ...
  return createSimpleVectorDB.ready
}

);
})();
export default createSimpleVectorDB;